...
const faqs = [
  {
    ...
    answer: "Обжаренный кофе лучше всего употребить в течение 2-4 недель после обжарки для максимальной свежести. Храните кофе в герметичной упаковке в тёмном прохладном месте."
  },
  {
  ...
  },
  {
    ...
    answer: "Мы работаем со светлой и средней обжаркой, которая раскрывает уникальные вкусовые характеристики каждого сорта кофе — от цитрусовых и ягодных нот до шоколадных и ореховых."
  },
];
